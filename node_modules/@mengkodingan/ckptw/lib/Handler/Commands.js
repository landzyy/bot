...
module.exports = (self) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (hasHears.length)
        return hasHears.map((x) => x.code(new Ctx_1.Ctx({ used: { hears: m.content }, args: [], self, client: self.core })));
    ...
    if (commandDetail.length)
        commandDetail.map((x) => x.code(new Ctx_1.Ctx({ used: { prefix: selectedPrefix, command }, args, self, client: self.core })));
});
